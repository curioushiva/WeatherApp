    ...
    if (WeatherData.error) {
        ...
        if (WeatherCode === 1000) {
            if (WeatherData.current.is_day === 1) {
                ...
                WImgCont.style.display = "flex"
                WeatherIMG = "assets/ani/clear.jpg";
            }
        ...
        if (WHour === 0) {
            CityLWTime.innerHTML = `12${WMinute} AM`
        }
        else if (WHour >= 1 && WHour <= 11) {
            CityLWTime.innerHTML = `${CHour}${WMinute} AM`
        }
        else if (WHour === 12) {
            CityLWTime.innerHTML = `12${WMinute} PM`
        }
        else {
            CityLWTime.innerHTML = `${CHour - 12}${WMinute} PM`
        }
    }
}
